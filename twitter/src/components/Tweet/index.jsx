...
export const Tweet =({name,username,children}) =>{
    ...
    const handleClick = () => {//manejador de eventos
       setLikes(prevState=>{
        if(prevState){
            return 0
        }
    ...
    <article className={styles.tweet}>
      ...
      <div className={styles.footer} >
        ...
        {/* OTRA FORMA */}
        {/* <li><button onClick={()=>setLikes(likes + 1)} ><FaHeart /> </button> <span>{likes} </span></li> */}
          {/* <li><button onClick={()=>setRt(rt + 1)}> <FaRetweet /> </button> <span>{rt}</span></li> */}
